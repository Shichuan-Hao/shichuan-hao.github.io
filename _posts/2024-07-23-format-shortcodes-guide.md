...
<tip>
写 Markdown 时，给文字加颜色需要写一长串 &lt;span style="color:red;"&gt;，非常繁琐。
...
<hl=purple>Elasticsearch</hl> 是一个分布式的 <color=red>搜索引擎</color>，
它的核心优势在于 <b>全文检索</b> 和 <u>近实时搜索</u>。

<tip>
ES 默认使用 <mark>倒排索引</mark> 来加速全文检索，这是其高性能的关键。
</tip>

<warn>
集群节点数量应为奇数，使用 <color=red>3</color> 个或更多主节点来避免脑裂问题。
</warn>
