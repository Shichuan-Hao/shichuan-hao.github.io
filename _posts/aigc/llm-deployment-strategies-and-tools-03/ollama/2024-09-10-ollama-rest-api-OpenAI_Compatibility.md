...
author: hsc
date: 2024-09-10 10:27:00 +0800
categories: [AI Agent]
tags: [Ollama]
---

本文聚焦 `OpenAI Compatibility` 。
...
client = OpenAI(
    base_url = "https://openai.com/api",  # 这里修改成可访问的 IP
    api_key = 'ollama',                   # 这里随便写，但是 api_key 字段一定要有
)
...
在 `OpenAI Compatibilty` 规范下，目前 `Ollama` 支持的模型参数如下：
