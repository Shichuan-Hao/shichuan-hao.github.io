...
title: "文本与排版"
description: "Quisque egestas convallis ipsum, ut sollicitudin risus tincidunt a."
author: hsc
date: 2024-12-08 17:27:00 +0800
categories: [博客运营]
tags: []
pin: true
math: true
...
#### H4 — 标题
{: data-toc-skip='' .mt-4 }<!-- markdownlint-restore -->
...
**表 1：标题在下方**{: .table-caption-bottom }
```
...
```mermaid
 gantttitle  为 mermaid 添加甘特图功能苹果 :a, 2017-07-20, 1w 香蕉 :crit, b, 2017-07-23, 1d 樱桃 :active, c, after b a, 1d
```
